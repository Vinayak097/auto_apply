...
let config = {
  ...
  headers: { 
    ...
    'x-apollo-signature': '1787974503-uLI%2FYtTrjgXCoqb%2BiCfd0jV7Mad1d3CypOdSBRZbqDc%3D', 
...
export async function JobSearchPage() {
  try {
    ...
    const filterConfiguration = buildJobSearchFilter(defaultFilter);
...
import { jobSearchResultsX } from './jobSearchResults';
